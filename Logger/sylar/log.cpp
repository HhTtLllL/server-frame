...
void Logger::setFormatter(const std::string& val){
	...
	if(new_val->isError()){
		std::cout << "Logger setFormatter name=" << m_name << " value=" << val << " invaild formatter" << std::endl;
		return;
	}
...
struct LogDefine{
	...
	bool operator==(const LogDefine& oth) const {
		return name == oth.name && formatter == oth.formatter && appenders == oth.appenders;
	}
